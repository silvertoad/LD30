...
public class GameUtils
{
    ...
    public static TComponent InstantiateAt<TComponent> (string _prefabId, GameObject _parent) where TComponent: Component
    {
        var instance = InstantiateAt (_prefabId, _parent);
