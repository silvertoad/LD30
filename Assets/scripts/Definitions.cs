...
public class Definitions
{
    ...
    void ReadIds ()
    {
        var idsAssets = Resources.Load<TextAsset> ("world/defs/ids").text;
        Debug.Log (idsAssets);
    ...
    void LoadPersets ()
    {
        var regionSource = Resources.Load<TextAsset> ("world/defs/presets").text;
...
public class Preset
{
    ...
    Dictionary<Dificult, int[]> Dificults = new Dictionary<Dificult, int[]> ();
